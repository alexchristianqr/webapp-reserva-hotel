...
<header class="py-3 border-bottom mb-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Panel de Configuraci�n</h2>
...
<main class="flex-fill">
    <p class="text-muted mb-5">
        Administra la informaci�n del sistema: habitaciones, empleados, productos, usuarios y clientes.
    </p>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm h-100 text-center p-3 border-0">
                <div class="card-body">
                    ...
                    <p class="text-muted">Consulta y gestiona los datos de tus hu�spedes.</p>
