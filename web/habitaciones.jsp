...
<header class="py-3 border-bottom mb-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Gesti�n de Habitaciones</h2>
    ...
    <table class="table table-hover table-bordered align-middle">
        ...
        <tbody>
            ...
            <tr v-for="(room, index) in state.rooms" :key="room.idHabitacion">
                ...
                <td>
                    <button class="btn btn-sm btn-primary me-2" title="Editar Habitaci�n" @click="openEditModal(room)">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="tipo" class="form-label">Tipo de Habitaci�n</label>
            ...
            const guardarHabitacion = async () => {
                ...
                try {
                    ...
                    if (!response.ok) {
                        ...
                        throw new Error('Error al guardar la habitaci�n');
                    }
